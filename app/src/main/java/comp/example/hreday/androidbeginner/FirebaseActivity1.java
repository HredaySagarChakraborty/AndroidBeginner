...
public class FirebaseActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("FirebaseActivity1");
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.chooseButton) {
            ...
            if(uploadTask!=null && uploadTask.isInProgress()){
                Toast.makeText(FirebaseActivity1.this, "Uploading in progress", Toast.LENGTH_SHORT).show();
            }
            ...
            Intent intent =new Intent(FirebaseActivity1.this,AndroidActivity.class);
    ...
    private void saveData() {
        ...
        ref.putFile(imageUri).addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(FirebaseActivity1.this, "Unsuccessfull", Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(FirebaseActivity1.this, "Succesfull", Toast.LENGTH_SHORT).show();
