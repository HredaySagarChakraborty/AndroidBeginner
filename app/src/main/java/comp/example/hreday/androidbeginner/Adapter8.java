...
public class Adapter8 extends RecyclerView.Adapter<Adapter8.ViewHolder> {
    ...
    public Adapter8(List<Upload7> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Upload7 upload=list.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            textView=itemView.findViewById(R.id.containerText);
            imageView=itemView.findViewById(R.id.containerImg);
