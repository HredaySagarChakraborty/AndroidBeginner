...
public class Adapter10 extends RecyclerView.Adapter<Adapter10.ViewHolder> {
    ...
    public Adapter10(List<Upload9> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Upload9 upload=list.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            textView=itemView.findViewById(R.id.sqliteText);
            imageView=itemView.findViewById(R.id.sqliteImg);
