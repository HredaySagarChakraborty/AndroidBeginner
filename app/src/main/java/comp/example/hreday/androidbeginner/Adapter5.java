...
public class Adapter5 extends RecyclerView.Adapter<Adapter5.ViewHolder> {
    ...
    public Adapter5(List<Upload4> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Upload4 upload=list.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            textView=itemView.findViewById(R.id.fragmentText);
            imageView=itemView.findViewById(R.id.fragmentImg);
