...
public class Adapter9 extends RecyclerView.Adapter<Adapter9.ViewHolder> {
    ...
    public Adapter9(List<Upload8> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Upload8 upload=list.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            textView=itemView.findViewById(R.id.storageText);
            imageView=itemView.findViewById(R.id.storageImg);
